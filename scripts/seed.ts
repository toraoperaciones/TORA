...
async function createTenants() {
  ...
  const rows = [
    ...
    {
      name: "Demo Crédito SA de CV",
      rfc: "DCR260101DDD",
      razon_social: "Demo Crédito Sociedad Anónima de Capital Variable",
      regimen_fiscal: "601",
      credit_limit: 50000,
      credit_days: 30,
      ...
      markup_cars: 0.13,
      markup_stands: 0.32,
      notes: "Tenant demo para el flujo de crédito (Sprint 2). Sin lógica activa.",
    },
  ];
