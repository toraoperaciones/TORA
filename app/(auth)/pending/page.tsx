...
export default function PendingPage() {
  return (
    <div className="flex flex-col items-center gap-6 border-border-subtle rounded-lg bg-surface p-8 text-center shadow-sm">
      <Logo size="lg" />
      <div className="flex flex-col gap-2">
        <h1 className="font-display text-h2 text-navy">Cuenta en revisión</h1>
        <p className="prose-tora text-body-s text-graphite">
